		...
		public class Row : Gtk.ListBoxRow
		{
			...
			private void update_repository_data()
			{
				...
				string head_description = "";
					...
					// gitrl-z severance: gitg reads a .doap file from the head tree here
					// and shows its short description and language tags. That needs
					// Ide.Doap from gitg's bundled contrib/ide, which needs
					// contrib/xml-reader and links libxml2 — roughly 1500 lines of
					// vendored C plus a link dependency, to decorate the dash entry of
					// repositories shipping a .doap file. Essentially only GNOME
					// projects do. Dropped for NFR-2. The branch name is unaffected.
